...
export default function BookParkingSlot() {
  ...
  const queryStartTime = parseInt(params.queryStartTime);
  const queryEndTime = parseInt(params.queryEndTime);
  const yearMonthDay = params.yearMonthDay;
